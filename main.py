...
class Vuelo:
    def _init_(self, numero_vuelo, origen, destino, fecha, salida, llegada, precio):
...
class Pasajero:
    def _init_(self, nombre, apellido, edad, telefono, correo):
        self.nombre = nombre
...
class Informacion:
    def _init_(self, vuelo, pasajero, asientos):
        self.vuelo = vuelo
...
def crear_pasajero_desde_input():
